...
class Recycler2BowlingAdapter(var context: Activity, var bowlOrBat: Int, var data:List<MatchScoreDetail.Data.Inning2Over>) :
    RecyclerView.Adapter<Recycler2BowlingAdapter.MyViewHolder?>() {
    //declare interface
